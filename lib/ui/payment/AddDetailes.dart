...
class _AddDelatesState extends State<AddDelates> {
  ...
  List<String> _Adress = ['Please choose a Adrees', 'Gaza', 'Egypt', 'Ramallah', 'Remal'];
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: ListView(
          ...
          children: [
            Text('Full name*',style: TextStyle(color: Color(0xff9A9A9A),fontSize:18,),),
            SizedBox(height: 10,),
            PaymentText(  controller:_fullname ),
            SizedBox(height: 20,),
            Text('Address1*',style: TextStyle(color: Color(0xff9A9A9A),fontSize:18,),),
            SizedBox(height: 5,),
            PaymentText(  controller:_address1 ),
            SizedBox(height: 20,),
            Text('Address2*',style: TextStyle(color: Color(0xff9A9A9A),fontSize:18,),),
            SizedBox(height: 5,),
            PaymentText(  controller:_address1 ),
            SizedBox(height: 20,),
            Container(
            ...
            Text('Zip Code*',style: TextStyle(color: Color(0xff9A9A9A),fontSize:18,),),
            SizedBox(height: 5,),
            PaymentText(  controller:_zipCode ),
            SizedBox(height: 20,),
            Text('City',style: TextStyle(color: Color(0xff9A9A9A),fontSize:18,),),
            SizedBox(height: 10,),
            Container(
              decoration: BoxDecoration(
